...
#define HPRE_PRESCALER_2        8
#define HPRE_PRESCALER_4        9
#define HPRE_PRESCALER_8        10
#define HPRE_PRESCALER_16       11
#define HPRE_PRESCALER_64       12
#define HPRE_PRESCALER_128      13
#define HPRE_PRESCALER_256      14
#define HPRE_PRESCALER_512      15


#define PPRE1_SEL_MSK           0xFFFFE3FF
#define PPRE2_SEL_MSK           0xFFFF1FFF
#define PPRE_NO_PRESCALER       0
#define PPRE_PRESCALER_2        4
#define PPRE_PRESCALER_4        5
#define PPRE_PRESCALER_8        6
#define PPRE_PRESCALER_16       7
